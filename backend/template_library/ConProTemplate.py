...
class SepNonePro(object):
    ...
    def setPassiveVerb(self,verb):
        self.passive_verb = []
        verb_array = verb.split(",")
        for v in verb_array:
            self.passive_verb.append(v)
...
class SepVerbPro(object):
    ...
    def getStandard(self):
        ...
        for v in self.passive_verb:
            standard_template.append("什么" + v + self.ent)
            standard_template.append("什么能" + v + self.ent)
...
class OnlyConPro(object):
    ...
    def getStandard(self):
        ...
        for v in self.verb:
            standard_template.append(self.ent + v + "什么")
            standard_template.append(self.ent + v + "哪些")
...
class RangeConPro(object):
    ...
    def getStandard(self):
        ...
        for v in self.verb:
            standard_template.append(self.ent + v + "什么")
            standard_template.append(self.ent + v + "什么情况")
